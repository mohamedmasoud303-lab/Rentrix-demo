    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={unit ? 'تعديل وحدة' : 'إضافة وحدة'}>
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label className="text-sm font-bold block mb-1 text-heading">اسم/رقم الوحدة</label>
                    <input 
                        name="name" 
                        value={data.name || ''} 
                ...
                <div>
                    <label className="text-sm font-bold block mb-1 text-heading">نوع الوحدة</label>
                    <input 
                        name="type" 
                        value={data.type || ''} 
                ...
                <div>
                    <label className="text-sm font-bold block mb-1 text-heading">الإيجار الافتراضي</label>
                    <input 
                        name="rentDefault" 
                        type="number" 
